...
MIDDLEWARE = [
    'video_sharing.middleware.BrokenPipeMiddleware',
    ...
    'video_sharing.middleware.SecurityHeadersMiddleware',
]
...
# CORS settings for React/Vite frontend integration
...
# Server settings to prevent broken pipe errors
